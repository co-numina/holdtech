...
const T = {
  en: {
    ...
    hero: "The technology behind",
    heroHighlight: "who's holding.",
    heroDesc: "Holder quality scoring, bundler intelligence, and on-chain wallet analysis for every Solana token. Know what you're buying into.",
    ...
    detectTitle: "What HoldTech does",
    detectDesc: 'Track known bundler wallets and add your own. Get <strong style="color: var(--text)">coordinated buy alerts</strong> when multiple bundlers hit the same token. Scan any token\'s holderbase — wallet age, funding source, buy timing, bundle patterns. <strong style="color: var(--text)">Live price data from DexScreener</strong> on every transaction.',
    verdictTitle: "Intelligence, not guesswork",
    verdictDesc: 'Every scan produces a letter grade (A–F), numerical score, specific red flags, and a plain-English verdict. The bundler feed shows you <strong style="color: var(--accent)">who\'s buying what, right now</strong> — with market cap, price changes, and SOL amounts. Know before you ape.',
    sybilTitle: "Bundler Feed",
    sybilDesc: "Track known rugger wallets and add your own. Live polling, group filters, SOL amounts, price data, and notification sounds. Import from any tracker.",
    qualityTitle: "Coordinated Buy Alerts",
    qualityDesc: "When 3+ tracked bundlers buy the same token — instant ⚠ COORDINATED BUY alert with total SOL, market cap, price data, and one-click scan.",
    concTitle: "Holder Quality Scan",
    concDesc: "Individual wallet profiling, funding trace, bundle detection, buy timing, concentration metrics, and scored verdicts. Deep scan every token in seconds.",
    howTitle: "How it works",
    step1: "Open the Dashboard — bundler feed loads automatically with 49 default rugger wallets",
    step2: "Watch real-time transactions, SOL amounts, and price data. Coordinated buys trigger red alerts",
    step3: "Click any token in the feed to inline-scan its holderbase — grade, score, and red flags in seconds",
    step4: "Add your own wallets, import from trackers, toggle LIVE mode for 15-second auto-refresh",
    ...
    holdtech: "✓ HoldTech",
    holdtechDesc: 'Real-time bundler tracking, coordinated buy alerts, inline holder scans, DexScreener price data, wallet profiling, funding traces, and scored verdicts. <strong style="color: var(--accent)">Full intelligence dashboard.</strong>',
    emptyTitle: "Scan a token above — or open the Dashboard for the full bundler feed",
    emptySub: "Analysis takes ~15-20 seconds · Top 100 holders · Dashboard is free",
    ...
    scopeDesc: "The dashboard is live. $HOLDTECH holders get more.",
    tierFree: "FREE",
    ...
    tierOperatorDesc: "50 watchlist · Batch 20 · Custom bundler groups · API access · Priority RPC",
    tierWhale: "WHALE",
    tierWhaleHold: "Hold 20M $HOLDTECH",
    tierWhaleDesc: "200 watchlist · Batch 50 · Raw data export · Early features · Unlimited everything",
    scopeFeed: "BUNDLER FEED",
    scopeFeedDesc: "49+ known rugger wallets tracked in real-time. SOL amounts, token images, DexScreener price data. 15-second live polling with notification sounds.",
    scopeDrill: "COORDINATED ALERTS",
    scopeDrillDesc: "When 3+ bundlers buy the same token — instant red alert. Total SOL deployed, market cap, price changes, and one-click holder scan.",
    scopeTrajectory: "INLINE SCANNING",
    scopeTrajectoryDesc: "Click any token in the bundler feed to scan its holderbase inline. Grade, score, holder count, concentration — without leaving the feed.",
    scopeCTA: "CA dropping soon · Dashboard live now",
    ...
    extHow: "Available on",
    extStep1: 'Pending review on the Chrome Web Store — coming soon.',
    extStep2: 'In the meantime, install manually from <a href="https://github.com/co-numina/holdtech/tree/main/extension" target="_blank" rel="noopener" style="color:var(--accent);text-decoration:underline">GitHub</a>.',
    extStep3: '',
  ...
  zh: {
    ...
    hero: "持有者背后的",
    heroHighlight: "技术。",
    heroDesc: "持有者质量评分、捆绑者情报和链上钱包分析，覆盖每一个Solana代币。看清你买入的是什么。",
    placeholder: "粘贴代币地址...",
    analyze: "分析",
    analyzing: "分析中...",
    beta: "测试版",
    ...
    detectTitle: "HoldTech 做什么",
    detectDesc: '追踪已知捆绑者钱包，也可添加自定义钱包。当<strong style="color: var(--text)">多个捆绑者买入同一代币时触发协调买入警报</strong>。扫描任意代币持币结构——钱包年龄、资金来源、买入时间、捆绑模式。<strong style="color: var(--text)">每笔交易附带DexScreener实时价格。</strong>',
    verdictTitle: "情报，非猜测",
    verdictDesc: '每次扫描生成字母等级（A–F）、数字分数、具体危险信号和中文评估报告。捆绑者动态显示<strong style="color: var(--accent)">谁在买什么，实时更新</strong>——附带市值、价格变化和SOL金额。入场前先了解。',
    sybilTitle: "捆绑者动态",
    sybilDesc: "追踪已知rugger钱包，也可添加自定义钱包。实时刷新，分组过滤，SOL金额，价格数据，通知声音。支持从任意追踪器导入。",
    qualityTitle: "协调买入警报",
    qualityDesc: "当3+追踪的捆绑者买入同一代币——即时⚠协调买入警报。显示总SOL、市值、价格变化，一键扫描。",
    concTitle: "持有者质量扫描",
    concDesc: "逐个钱包分析、资金追踪、捆绑检测、买入时间、集中度指标和评分报告。秒级深度扫描。",
    howTitle: "工作原理",
    step1: "打开仪表盘——捆绑者动态自动加载49个默认rugger钱包",
    step2: "查看实时交易、SOL金额和价格数据。协调买入触发红色警报",
    step3: "点击动态中任意代币即可内联扫描——评级、分数和危险信号秒出",
    step4: "添加自己的钱包，从追踪器导入，开启LIVE模式15秒自动刷新",
    dataSource: "数据来源：",
    ...
    holdtech: "✓ HoldTech",
    holdtechDesc: '实时捆绑者追踪、协调买入警报、内联扫描、DexScreener价格数据、钱包分析、资金追踪和评分报告。<strong style="color: var(--accent)">全景情报仪表盘。</strong>',
    emptyTitle: "在上方扫描代币——或打开仪表盘查看完整捆绑者动态",
    emptySub: "分析耗时约15-20秒 · 前100名持有者 · 仪表盘免费使用",
    ...
    scopeDesc: "仪表盘已上线。持有$HOLDTECH获得更多。",
    tierFree: "免费",
    ...
    tierOperatorDesc: "50个关注位 · 批量20个 · 自定义捆绑者分组 · API · 优先RPC",
    tierWhale: "鲸鱼",
    tierWhaleHold: "持有 20M $HOLDTECH",
    tierWhaleDesc: "200个关注位 · 批量50个 · 原始数据导出 · 抢先体验 · 无限制",
    scopeFeed: "捆绑者动态",
    scopeFeedDesc: "49+已知rugger钱包实时追踪。SOL金额、代币图片、DexScreener价格数据。15秒实时刷新，带通知声音。",
    scopeDrill: "协调警报",
    scopeDrillDesc: "当3+捆绑者买入同一代币——即时红色警报。部署SOL总额、市值、价格变化，一键扫描。",
    scopeTrajectory: "内联扫描",
    scopeTrajectoryDesc: "点击捆绑者动态中任意代币即可内联扫描。评级、分数、持有者数量、集中度——无需离开动态页。",
    scopeCTA: "CA即将公布 · 仪表盘已上线",
    extTitle: "浏览器插件",
    extTagline: "不离开页面即可扫描代币。",
    extDesc: "在pump.fun、DexScreener、Birdeye和Solscan上自动注入持有者质量评分。点击图标随时粘贴CA获取即时评级。",
    extHow: "获取方式",
    extStep1: 'Chrome Web Store 审核中——即将上线。',
    extStep2: '目前可从 <a href="https://github.com/co-numina/holdtech/tree/main/extension" target="_blank" rel="noopener" style="color:var(--accent);text-decoration:underline">GitHub</a> 手动安装。',
    extStep3: '',
    extFeature1: "弹窗扫描",
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: "1100px", margin: "0 auto", padding: "0 32px" }}>
        ...
        <div className="glass" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 24px", borderRadius: "16px", marginTop: "16px", flexWrap: "nowrap", minHeight: "52px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
            ...
            <a href="/dashboard" className="font-mono" style={{ fontSize: "11px", fontWeight: 600, padding: "3px 10px", borderRadius: "6px", color: "var(--text-muted)", textDecoration: "none", transition: "all 0.15s" }}
              onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => { e.currentTarget.style.color = "var(--accent)"; e.currentTarget.style.background = "rgba(153,69,255,0.08)"; }}
              onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => { e.currentTarget.style.color = "var(--text-muted)"; e.currentTarget.style.background = "transparent"; }}>
              DASHBOARD
            </a>
            <a href="/overlap" className="font-mono" style={{ fontSize: "11px", fontWeight: 600, padding: "3px 10px", borderRadius: "6px", color: "var(--text-muted)", textDecoration: "none", transition: "all 0.15s" }}
              onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => { e.currentTarget.style.color = "var(--accent)"; e.currentTarget.style.background = "rgba(153,69,255,0.08)"; }}
              onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => { e.currentTarget.style.color = "var(--text-muted)"; e.currentTarget.style.background = "transparent"; }}>
              OVERLAP
            </a>
            ...
            <a href="/trending" className="font-mono" style={{ fontSize: "11px", fontWeight: 600, padding: "3px 10px", borderRadius: "6px", color: "var(--text-muted)", textDecoration: "none", transition: "all 0.15s" }}
              onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => { e.currentTarget.style.color = "var(--accent)"; e.currentTarget.style.background = "rgba(153,69,255,0.08)"; }}
              onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => { e.currentTarget.style.color = "var(--text-muted)"; e.currentTarget.style.background = "transparent"; }}>
              TRENDING
            </a>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", gap: "12px", marginTop: "20px" }}>
              <a href="/dashboard" style={{
                ...
                textDecoration: "none", boxShadow: "0 4px 16px var(--accent-glow)",
                transition: "transform 0.15s, box-shadow 0.15s",
              }}>
                ⬡ {lang === "en" ? "Open Dashboard" : "打开仪表盘"}
              </a>
              <a href="https://github.com/co-numina/holdtech" target="_blank" rel="noopener" style={{
                display: "inline-flex", alignItems: "center", gap: "6px", padding: "12px 20px",
                background: "var(--bg-card)", border: "1px solid var(--border-accent)",
                color: "var(--text-secondary)", borderRadius: "14px", fontSize: "13px", fontWeight: 600,
        ...
        <div style={{ marginBottom: "32px" }}>
          <div style={{ display: "flex", gap: "8px", alignItems: "stretch" }}>
            <div style={{ flex: 1, position: "relative", display: "flex", alignItems: "center" }}>
              <div style={{ position: "absolute", left: "16px", top: "50%", transform: "translateY(-50%)", pointerEvents: "none", display: "flex", zIndex: 2 }}>
