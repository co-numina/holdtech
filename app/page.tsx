...
const T = {
  en: {
    ...
    detectDesc: 'Track 49+ known bundler wallets in real-time. Get <strong style="color: var(--text)">coordinated buy alerts</strong> when 3+ bundlers hit the same token. Scan any token\'s holderbase — wallet age, funding source, buy timing, bundle patterns. <strong style="color: var(--text)">See price impact data from DexScreener</strong> on every transaction. One-click inline scans from the feed.',
    ...
    sybilDesc: "Track 49+ known rugger wallets in real-time. 15s polling, group filters, SOL amounts, notification sounds. See what they're buying before you get drilled.",
  ...
  zh: {
    ...
    detectDesc: '实时追踪49+已知捆绑者钱包。当<strong style="color: var(--text)">3+捆绑者买入同一代币时触发协调买入警报</strong>。扫描任意代币的持币结构——钱包年龄、资金来源、买入时间、捆绑模式。<strong style="color: var(--text)">每笔交易附带DexScreener价格数据。</strong>',
    verdictTitle: "情报，非猜测",
    ...
    sybilTitle: "捆绑者动态",
    sybilDesc: "实时追踪49+已知rugger钱包。15秒刷新，分组过滤，SOL金额，通知声音。在被钻之前看到他们在买什么。",
    qualityTitle: "协调买入警报",
